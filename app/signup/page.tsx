...
import { createAccountUrl } from "../helpers/api-endpoints";
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-8 lg:p-12">
          <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 sm:p-10 text-slate-900">
            ...
            <form className="space-y-5" onSubmit={(e) => {
              e.preventDefault()
              console.clear()
              const fullNameInput = document.querySelector(`#full-name`) as HTMLInputElement
              const emailInput = document.querySelector(`#email-input`) as HTMLInputElement
              const passwordInput = document.querySelector(`#password-input`) as HTMLInputElement
              const roleInput = document.querySelector(`#role-input`) as HTMLInputElement
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700 tracking-wide" htmlFor="full-name">
                  Full Name
                </label>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Users className="w-5 h-5 absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" />
                  <select
                    id="role-input"
                    className="w-full pl-11 pr-10 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all placeholder:text-slate-400"
                  >
